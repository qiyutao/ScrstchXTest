...
(function(ext) {
  ...
  var blocks = {
    ...
    pl: [
      ...
      [' ', 'zmień jasno?? %m.leds o %n%', 'changeLED', 'led A', 20],
      ['-'],
      [' ', 'obró? %m.servos w po?o?enie %n degrees', 'rotateServo', 'serwo A', 180],
      [' ', 'obró? %m.servos o %n degrees', 'changeServo', 'serwo A', 20],
      ['-'],
