...
(function(ext) {
  ...
  var blocks = {
    en: [
      ...
      [' ', '连接 %m.hwOut 到引脚 %n', 'connectHW', '发光二极体 A', 3],
      [' ', '连接 %m.hwIn 到模拟 %n', 'connectHW', '旋钮', 0],
      ['-'],
      [' ', '设定 %m.leds %m.outputs', 'digitalLED', '发光二极管 A', 'on'],
      [' ', '设定 %m.leds 亮度为 %n%', 'setLED', '发光二极管 A', 100],
      [' ', '改变 %m.leds 亮度 %n%', 'changeLED', '发光二极管 A', 20],
      ['-'],
      [' ', '旋转 %m.servos 到 %n 度', 'rotateServo', '舵机马达 A', 180],
      [' ', '旋转 %m.servos %n 度', 'changeServo', '舵机马达 A', 20],
      ['-'],
      ...
      ['-'],
      [' ', '设定引脚 %n %m.outputs', 'digitalWrite', 1, '开'],
      [' ', '设定引脚 %n 为 %n%', 'analogWrite', 3, 100],
      ['-'],
      ['h', '当引脚 %n 为 %m.outputs', 'whenDigitalRead', 1, '开'],
      ['b', '引脚 %n 开?', 'digitalRead', 1],
      ['-'],
      ['h', '当模拟 %n %m.ops %n%', 'whenAnalogRead', 1, '>', 50],
      ['r', '读取模拟 %n', 'analogRead', 0],
      ['-'],
