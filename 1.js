...
(function(ext) {
  ...
  var blocks = {
    en: [
      ...
      [' ', '连接 %m.hwOut 到脚位 %n', 'connectHW', '发光二极体 A', 3],
      [' ', '连接 %m.hwIn 到类比 %n', 'connectHW', '旋钮', 0],
      ['-'],
      [' ', '设定 %m.leds %m.outputs', 'digitalLED', '发光二极体 A', 'on'],
      [' ', '设定 %m.leds 亮度为 %n%', 'setLED', '发光二极体 A', 100],
      [' ', '改变 %m.leds 亮度 %n%', 'changeLED', '发光二极体 A', 20],
      ['-'],
      ...
      ['-'],
      [' ', '设定脚位 %n %m.outputs', 'digitalWrite', 1, '开'],
      [' ', '设定脚位 %n 为 %n%', 'analogWrite', 3, 100],
      ['-'],
      ['h', '当脚位 %n 为 %m.outputs', 'whenDigitalRead', 1, '开'],
      ['b', '脚位 %n 开?', 'digitalRead', 1],
      ['-'],
